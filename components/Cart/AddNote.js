    ...
    return (
        <Modal>
            ...
            <div className="flex-between space-x-3 mt-3">
                <button className='btn bg-gray-600 hover:bg-gray-700 text-sm' onClick={() => setIsNote(null)}>Cancel</button>
                <div className="flex items-center space-x-3">
                    <button className='bg-red-500 hover:bg-red-600 text-sm btn' onClick={handleClear}>Clear</button>
                    <button className='btn text-sm' onClick={handleConfirm}>Confirm</button>
                </div>
            </div>
        </Modal>
    )
